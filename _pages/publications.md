...
{% if site.author.googlescholar %}
  <p class="page-intro">A Google Scholar version of this list is also available on <a href="{{ site.author.googlescholar }}">my Google Scholar profile</a>.</p>
{% endif %}

<h2>Peer-Reviewed Publications</h2>

<p>All publications below are full-length papers. The list is ordered by year.</p>
